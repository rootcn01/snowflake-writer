...
- v2.8.1: Bug修复+小功能：备份弹窗、导出合并、AI模型自定义 ✅
- v2.8.2: 工具栏隐藏+快捷键、自定义背景 ✅
- v2.9: 大重构：Step 10重构、关系图/时间线重构、玻璃拟态UI ⏳
- v2.10: 地图绘制功能 ⏳
...
| 2.8.1 | Bug修复+小功能：备份弹窗、导出合并、AI模型自定义 | P1 | ✅ 已完成 |
| 2.8.2 | 工具栏隐藏+快捷键、自定义背景 | P2 | ✅ 已完成 |
| 2.9 | 大重构：Step 10重构、关系图/时间线重构、玻璃拟态UI | P1 | ⏳ 待详细设计 |
| 2.10 | 地图绘制功能 | P2 | ⏳ 待详细设计 |
